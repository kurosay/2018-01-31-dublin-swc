...
venue: "VB"        # brief name of host site without address (e.g., "Euphoric State University")
...
helper: ["FIXME"]     # boxed, comma-separated list of helper' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
